...
export const followUnfollowUser = async (req,res) => {
    try {
        ...
        if(!userToModify || !currentUser) return res.status(400).json({error: "User not found inside user controller"});
...
export const updateUser = async(req , res) => {
    ...
    try{
        ...
        if(profileImg){
            ...
            if(user.profileImg){
                //https://res.cloudinary.com/dx3x66zpi/image/upload/v1633662927/twitterClone/avatars/avataaars
